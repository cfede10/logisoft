...
?>
	...
	<table STYLE="table-layout: fixed; width=100%">
		...
		<tr>
			<td>
				<div class="">
					<?php echo $form->labelEx($model,'preciounidad'); ?>
					<?php echo $form->textField($model,'preciounidad',array('size'=>45,'maxlength'=>45)); ?>
					<?php echo $form->error($model,'preciounidad'); ?>
				</div>
			</td>
		</tr>
		<tr>
			<td>
				<div class="">
					...
					<?php echo $form->dropDownList($model,'producto_id',$model->getMenuProductos(),array("empty"=>"Seleccione")); ?>
		...
		<tr>
			<td>
				<div class="">
					<?php echo $form->labelEx($model,'stockcol'); ?>
					<?php echo $form->textField($model,'stockcol',array('size'=>45,'maxlength'=>45)); ?>
					<?php echo $form->error($model,'stockcol'); ?>
				</div>
			</td>
		</tr>
	</table>
