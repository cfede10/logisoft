...
class Vehiculo extends CActiveRecord {
	...
	public function rules() {
		...
		return array (
				array (
						'patente, modelo, marca, ano',
						'required' 
				),
				array (
						'patente, modelo, marca, creadopor, modificadopor',
						'length',
						'max' => 45 
				),
				array (
				...
				array (
						'id, patente, modelo, marca, ano, fechacreacion, fechamodificacion, creadopor, modificadopor',
						'safe',
						'on' => 'search' 
				) 
		);
