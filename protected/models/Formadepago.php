...
/**
 * This is the model class for table "formadepago".
 *
 * The followings are the available columns in table 'formadepago':
 * @property integer $id
 ...
 */
class Formadepago extends CActiveRecord {
	/**
	 *
	 ...
	 * @return Formadepago the static model class
	 */
